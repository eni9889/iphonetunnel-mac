...
mach_error_t AMDeviceStartService(struct am_device *device, CFStringRef service_name,struct afc_connection **handle, unsigned int * unknown);
...
mach_error_t AMDeviceRemoveValue(struct am_device *device, unsigned int, const CFStringRef *cfstring);
